...
class AbstractLazySequence(object):
    ...
    corpus views objects, which provide access to the contents of a
    ...
    def iterate_from(self, start):
        ...
        file underlying this corpus views, starting at the token number
    ...
    def __getitem__(self, i):
        ...
        corpus views.  Negative indices and spans are both supported.
        """
    ...
    def __iter__(self):
        """Return an iterator that generates the tokens in the corpus
        file underlying this corpus views."""
    ...
    def __repr__(self):
        """
        Return a string representation for this corpus views that is
    ...
    def __hash__(self):
        """
        :raise ValueError: Corpus views objects are unhashable.
        """
