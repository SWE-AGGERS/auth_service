...
class NombankCorpusReader(CorpusReader):
    ...
    def instances(self, baseform=None):
        """
        :return: a corpus views that acts as a list of
    ...
    def lines(self):
        """
        :return: a corpus views that acts as a list of strings, one for
    ...
    def nouns(self):
        """
        :return: a corpus views that acts as a list of all noun lemmas
