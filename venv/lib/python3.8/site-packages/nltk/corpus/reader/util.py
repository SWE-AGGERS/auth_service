...
class StreamBackedCorpusView(AbstractLazySequence):
    """
    A 'views' of a corpus file, which acts like a sequence of tokens:
    ...
    increase the memory requirements of the corpus views's internal
    ...
    have high degrees of locality, the corpus views may cache one or
    more blocks.
    ...
    :ivar _eofpos: The character position of the last character in the
        file.  This is calculated when the corpus views is initialized,
    ...
    def __init__(self, fileid, block_reader=None, startpos=0, encoding='utf8'):
        """
        Create a new corpus views, based on the file ``fileid``, and
        read with ``block_reader``.  See the class documentation
        for more information.

        :param fileid: The path to the file that is read by this
            corpus views.  ``fileid`` can either be a string or a
            ``PathPointer``.

        :param startpos: The file position at which the views will
    ...
    fileid = property(
        ...
        doc="""
        The fileid of the file that is accessed by this views.
    ...
    def _open(self):
        """
        Open the file stream associated with this corpus views.  This
        will be called performed if any value is read from the views
    ...
    def close(self):
        """
        Close the file stream associated with this corpus views.  This
        can be useful if you are worried about running out of file
        handles (although the stream should automatically be closed
        upon garbage collection of the corpus views).  If the corpus
        views is accessed after it is closed, it will be automatically
        re-opened.
        """
...
class ConcatenatedCorpusView(AbstractLazySequence):
    """
    A 'views' of a corpus file that joins together one or more
...
class PickleCorpusView(StreamBackedCorpusView):
    """
    A stream backed corpus views for corpus files that consist of
    ...
    def __init__(self, fileid, delete_on_gc=False):
        """
        Create a new corpus views that reads the pickle corpus
        ``fileid``.
    ...
    def __del__(self):
        ...
        ``PickleCorpusView`` was created, then delete the corpus views's
    ...
    def cache_to_tempfile(cls, sequence, delete_on_gc=True):
        ...
        corpus; and then return a ``PickleCorpusView`` views for that
