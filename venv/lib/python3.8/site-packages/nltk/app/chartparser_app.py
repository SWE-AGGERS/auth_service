...
class ChartMatrixView(object):
    """
    A views of a chart that displays the contents of the corresponding matrix.
    """
...
class ChartView(object):
    ...
    :ivar _chart: The chart that we are giving a views of.  This chart
    ...
    :ivar _edgelevels: A list of edges at each level of the chart (the
        ...
        are overlapping on the chart views.
    ...
    def _resize(self):
        ...
        scrollbars to views the entire display.  This does *not*
        resize the window.
        """
        c = self._chart_canvas
