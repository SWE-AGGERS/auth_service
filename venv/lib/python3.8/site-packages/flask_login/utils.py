...
def expand_login_view(login_view):
    '''
    Returns the url for the login views, expanding the views name to a url if
    needed.

    :param login_view: The name of the login views or a URL for the login views.
    :type login_view: str
    '''
...
def login_url(login_view, next_url=None, next_field='next'):
    ...
    so that the login views can redirect back to that URL. Flask-Login's default
    ...
    :param login_view: The name of the login views. (Alternately, the actual
                       URL to the login views.)
    :type login_view: str
    :param next_url: The URL to give the login views for redirection.
    :type next_url: str
...
def login_required(func):
    '''
    If you decorate a views with this, it will ensure that the current user is
    logged in and authenticated before calling the actual views. (If they are
    ...
    :param func: The views function to decorate.
    :type func: function
    '''
    @wraps(func)
...
def fresh_login_required(func):
    '''
    If you decorate a views with this, it will ensure that the current user's
...
def set_login_view(login_view, blueprint=None):
    '''
    Sets the login views for the app or blueprint. If a blueprint is passed,
    the login views is set for this blueprint on ``blueprint_login_views``.

    :param login_view: The user object to log in.
    :type login_view: str
    :param blueprint: The blueprint which this login views should be set on.
        Defaults to ``None``.
