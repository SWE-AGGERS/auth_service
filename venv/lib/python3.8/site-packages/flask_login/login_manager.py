...
class LoginManager(object):
    ...
    def __init__(self, app=None, add_context_processor=True):
        ...
        #: The name of the views to redirect to when the user needs to log in.
        ...
        #: The name of the views to redirect to when the user needs to
        #: reauthenticate.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the app is using blueprints find the login views for
              the current blueprint using `blueprint_login_views`. If the app
              is not using blueprints or the login views for the current
              blueprint is not specified use the value of `login_view`.

            - Redirect the user to the login views. (The page they were
        ...
        This should be returned from a views or before/after_request function,
